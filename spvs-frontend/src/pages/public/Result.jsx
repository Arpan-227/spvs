...
function buildPrintHTML(data) {
  ...
  var TH  = 'padding:5px;border:1px solid #C88010;font-weight:700;font-size:10px;text-align:center;background:#E8A020;color:#fff;line-height:1.3;'
  var TH2 = 'padding:5px;border:1px solid #C88010;font-weight:700;font-size:10px;text-align:center;background:#F0B030;color:#fff;line-height:1.3;'
  ...
  var TD  = 'padding:5px 4px;border:1px solid #E8B060;font-size:11.5px;text-align:center;color:#1C0A00;'
  var TDL = 'padding:5px 8px;border:1px solid #E8B060;font-size:12px;text-align:left;color:#1C0A00;font-weight:700;'
  ...
  var sRows = (data.subjects||[]).map(function(s,i){
    ...
    return '<tr style="background:'+bg+'">'+
      ...
      '<td style="'+TD+';font-weight:700;">'+(s.maxMarks||100)+'</td>'+
            ...
            {(data.subjects||[]).map(function(sub,i){
              ...
              return (
                <tr key={i} style={{ background:bg }}>
                  ...
                  <td style={{ ...TD, fontWeight:'700' }}>{sub.maxMarks||100}</td>
