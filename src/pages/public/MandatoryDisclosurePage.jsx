                    ...
                    <tbody>
                      {sec.rows.map(function(row, i) {
                        ...
                        return (
                          ...
                          >
                            <td style={{padding:'13px 24px', fontSize:'13.5px', fontWeight:'600', color:'var(--txt3)', width:'38%', verticalAlign:'middle'}}>{row[0]}</td>
                            <td style={{padding:'13px 24px', fontSize:'13.5px', fontWeight:'600', color:'var(--dark)', verticalAlign:'middle'}}>{row[1]}</td>
                            <td style={{padding:'13px 18px', verticalAlign:'middle', whiteSpace:'nowrap'}}>
                              {certInfo ? (
                                certInfo.ready ? (
                                  <a href={'/pdfs/' + encodeURIComponent(certInfo.file)} target="_blank" rel="noopener noreferrer"
                                    style={{display:'inline-flex', alignItems:'center', gap:'5px', padding:'6px 13px', borderRadius:'8px', background:'linear-gradient(135deg,var(--or),var(--gd))', color:'#fff', fontSize:'11.5px', fontWeight:'800', textDecoration:'none', boxShadow:'0 3px 10px rgba(232,118,26,.28)', transition:'all .2s', whiteSpace:'nowrap'}}
                                    onMouseEnter={function(e){e.currentTarget.style.transform='translateY(-1px)';e.currentTarget.style.boxShadow='0 6px 16px rgba(232,118,26,.38)'}}
                                    onMouseLeave={function(e){e.currentTarget.style.transform='none';e.currentTarget.style.boxShadow='0 3px 10px rgba(232,118,26,.28)'}}>
                                    👁 View
                                  </a>
                                ) : (
                                  <span style={{display:'inline-flex', alignItems:'center', gap:'5px', padding:'6px 13px', borderRadius:'8px', background:'rgba(0,0,0,.05)', color:'var(--txt3)', fontSize:'11.5px', fontWeight:'700', whiteSpace:'nowrap', cursor:'default'}}>
                                    🕐 Soon
                                  </span>
                                )
                              ) : null}
