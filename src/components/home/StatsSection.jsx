...
function StatItem({ em, n, sfx, lbl }) {
  ...
  return (
    <div className="stat-item" ref={ref}>
      <span className="stat-em">{em}</span>
  ...
  return (
    <section className="stats-sect">
      <div className="stats-grid">
        <StatItem em="🎓" n={1410} sfx="+" lbl="Students Enrolled" />
        <StatItem em="👨‍🏫" n={64} sfx="+" lbl="Qualified Teachers" />
        <StatItem em="🚌" n={22} sfx="" lbl="School Buses" />
        <StatItem em="🏆" n={100} sfx="%" lbl="Board Pass Rate" />
      </div>
    </section>
  )
}